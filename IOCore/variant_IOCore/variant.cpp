...
const PinDescription g_APinDescription[]=
{
    ...
    { PORTB,   6, PIO_ANALOG, PIN_ATTR_DIGITAL,  No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE },      // 25 ICE40_CDONE      SERCOM -------------
    ...
    { PORTA, 16, PIO_TIMER_ALT, PIN_ATTR_NONE , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 },
    { PORTA, 17, PIO_TIMER_ALT, PIN_ATTR_NONE , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 },
    { PORTB, 23, PIO_TIMER_ALT, PIN_ATTR_NONE , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 },
    { PORTB, 07, PIO_TIMER_ALT, PIN_ATTR_NONE , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 },
    { PORTA, 00, PIO_TIMER_ALT, PIN_ATTR_NONE , No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_3 },
